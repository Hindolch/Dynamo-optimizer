...
def main():
    ...
    results["AdamW"] = train_model(
        AdamWWrapper, "AdamW", train_loader, device,
    ...
    print("Training with DynamoThermostat...")
    results["DynamoThermostat"] = train_model(
        DynamoThermostat, "DynamoThermostat", train_loader, device,
        epochs=2, lr=1e-3, weight_decay=1e-2, small_update_threshold=small_update_threshold
    )
